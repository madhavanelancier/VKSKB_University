...
public class QrCodeActivity extends Activity implements Callback, OnClickListener {
    ...
    private void handleResult(String resultString) {
        if (TextUtils.isEmpty(resultString)) {
            ...
            Log.i(LOGTAG,"Got scan result from user loaded image :"+resultString);
    ...
    private static class WeakHandler extends Handler {
        ...
        private void handleResult(String resultString) {
            Log.i("utilsssssssresult",resultString+"     mas");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        overridePendingTransition(R.anim.slide_come_left,R.anim.slide_out_right);
